Feature: Link to page on the site
  ...
  Scenario: Add a link to an internal page
    ...
    When I press "Insert link"
      And I press "Save"
    Then I should see the link "Linkit Target" in the "Boxton Content" region
  ...
  Scenario: Add a link to an external page
    When I click the "Linkit" button in the "edit-body-und-0-value" WYSIWYG editor
      ...
      And I press "Save"
    Then I should see the link "https://drupal.org/project/panopoly" in the "Boxton Content" region
